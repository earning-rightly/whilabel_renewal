      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(state.texts.nameBoxTitle,style: TextStylesManager.bold14),
            ...
            const SizedBox(height: 32),
            Text(state.texts.genderBoxTitle,style: TextStylesManager.bold14),
            const SizedBox(height: 10),
            Row(
              children: [
                Expanded(
                  ...
                  child: ElevatedButton(
                    onPressed: (){
                      ref.read(_viewModel.provider.notifier).genderBtnTapped(Gender.male);
                    },
                    ...
                    child: Text(state.texts.maleBtnTitle, style: TextStylesManager.bold16,),
                  ),
                ),
                ...
                Expanded(
                  ...
                  child: ElevatedButton(
                    onPressed: (){
                      ref.read(_viewModel.provider.notifier).genderBtnTapped(Gender.female);
                    },
                    style: ElevatedButton.styleFrom(
                      side: const BorderSide(color: ColorsManager.brown100),
                      fixedSize: const Size(142, 52),
                    ...
                    child: Text(state.texts.femaleBtnTitle, style: TextStylesManager.bold16,),
                  ),
                ),
              ],
            ),
            ...
            const SizedBox(height: 32),
            Text(state.texts.datePickerBoxTitle,style: TextStylesManager.bold14),
            const SizedBox(height: 10),
            ...
            Container(
              ...
              child: Center(
                child: TextButton(
                  onPressed: () {
                    final date = ref.read(_datePickerViewModel.provider.notifier).getResult();

                    ref.read(_viewModel.provider.notifier).registerBtnTapped(_nicknameController.text, date);
                  },
                  child: Text(
